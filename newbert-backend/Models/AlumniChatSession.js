...
const schema=new mongoose.Schema({
  ...
  currentQuestionId:{type:String,default:'name'},currentSection:{type:String,default:'Basics'},progress:{type:Number,default:0},
  status:{type:String,enum:['IN_PROGRESS','REVIEW','COMPLETED','ABANDONED'],default:'IN_PROGRESS'},
  startedAt:{type:Date,default:Date.now},lastActivityAt:{type:Date,default:Date.now},completedAt:Date,
  publishedAlumniId:{type:mongoose.Schema.Types.ObjectId,ref:'Alumni'},
  publishLockUntil:Date,
},{timestamps:true,optimisticConcurrency:true});
module.exports=mongoose.model('AlumniChatSession',schema);
