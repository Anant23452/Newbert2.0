...
const { listRequests, reviewRequest } = require("../Controllers/collegeController");
...
router.get("/college-requests", listRequests);
router.patch("/college-requests/:id", reviewRequest);
