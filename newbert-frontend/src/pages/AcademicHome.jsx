...
import { academicBranches, inferAcademicYear, profileBranch, validYear } from '../utils/academicYear';
import { isReviewDue, readStudyLocal } from '../utils/studyTools';
...
export default function AcademicHome() {
  ...
  const selectedYear = validYear(readStudyLocal(`newbert-academic:${progress.scope}:${academic.session}`, null)) || academic.year;
