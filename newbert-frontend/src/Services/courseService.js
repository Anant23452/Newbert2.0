...
export async function getRecommendedCourses() { const { data } = await API.get("/courses/recommended"); return data; }
export async function getCourseFit(id) { const { data } = await API.get(`/courses/${id}/fit`); return data; }
