...
export async function analyzeRawAdminJob(rawText, sourceUrl = "") { const { data } = await API.post("/admin/jobs/analyze-raw", { rawText, sourceUrl }); return data.draft; }
export async function getLeaderboard(params) { const { data } = await API.get("/leaderboard", { params }); return data; }
